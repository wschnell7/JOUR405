...
Education levels in the survey samples often differ from the general population because of the weight of each response. In the data table, every response had a different weight causing some education groups to be over represented and others to be underrepresented. 
...
As people grow older and attend college, they are more likely to vote yes rather than not having a general idea. 
...
High scool or less saw the biggest change after applying weights as it changed around 3 percentage points. 

2. Why might the weighted results be considered more accurate than the unweighted results?

Weighted results can be more accurate because if college studetns are more likely to respond to a survey than high school kids, it makes the results more accurate and less biased if one group is more likely to respond than another. 
...
High school or less shows the largest differences between weighted and unweighted results because each category changed by at least one percent
...
It is important for journalists to understand survey weighting when reporting on polls because when they're is survey weighting, people can be under or over represented which can skew the results of the survey.

2. How might the differences between weighted and unweighted results affect how you would report on this data?

The differences might affect how I would report on this data because high school or less students had the biggest difference between weighted and unweighted results because they are less likely to respond to the survey than college studetns so taking that into account when reporting is important. 
...
I want to know if weights are calculated based of a percentage of one group of people responding compared to the total number of people that respond to the survey. 