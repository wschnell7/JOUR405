...
Percentage of people unemployed and voter turnout seems to be negatively correlated and there is a strong negativity relationship between the two variables. Median age and percentage of bachelors higher seem to be uncorrelated based on the visualization matrix. Percentage of white and voter turnout has a strong positive linear relationship as most points are on or just off the linear regression line. Population and voter turnout seems to have no linear relationship because the linear regression line doesn't have any data points that are directly on the line. 
...
This model does a good job at predicting turnouts because variables with a negative t-value are the variables that have a negative relationship with the dependent variable. Variables that have a positive t-value have a positive relationship with the dependent variable. I think it is a useful model because the t-value says a lot about the relationship between the variable and the dependent variable. 
...
I think the visual models are more significant than the others because it is easy to visualize the relationship between two variables. The model below shows a p-value of 3.657e-05 which shows that there is strong statistical evidence between the variables that are being compared to the dependent variable. 
...
To cover an election, the r squared values is a useful statistic to look at when comparing voter tunrout to other statistics like age and income. The r squared value shows the affect that each variable has on another and when one variable changes, it shows how the other variable changes. 