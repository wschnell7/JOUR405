...
The data for Spike year is the highest out of the three. It has the highest average for number of thefts and it has the highest average theft rate out of the three categories. However, it has the lowest sample size of just 12.: The median rate nearly tripled from the 22.2 in the pre-spike to 58.1 in the spike year but the sample sizes varied a great deal, with 71 observations in pre-spike versus 12 in the spike year.
...
A better tittle for the chart is Average Car Theft Rate per year in Prince George's County. The output of the chart shows when the rate of car thefts peaked and it also shows the trend of the rate in previous years. 
...
- **Null Hypothesis (H0)**:   A spike in car thefts in 2023 has no affect for an increase in future car thefts

- **Alternative Hypothesis (H1)**: A spike in car thefts in 2023 has increased the rate of car thefts in the following years
...
There are real significant differences in the average rates between the time periods. This because after co pleting an ANOVA test, the f-value is 2e-16 which illustrates the fact that the differences between the time periods is significant. 
...
When looking at the results of the Tukey test, there is a significant difference between the three time periods. he biggest difference is between the pre-spike year and the spike year. This difference shows the change that came with the spike year. A possible headline based on gthe results is that a spike in car thefts in 2023 has increased the average theft rates for the following years. all the tests back up the evidence and show that the results are significant.