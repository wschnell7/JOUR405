...
I was able to run every line except the last one where I had to put the code that loads the students.csv file from the url. I copied and pasted everything from the url provided and when I ran it nothing would go through. 
