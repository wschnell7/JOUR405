...
There aren't many patterns I see when looking at the graph becuase there are no continuous trends. It tends to fluctuate over the course of the year that the date was collected from. 
...
It differs from the graph in task 3 because this graph shows the un usually high and low calls and it is more clear how much they stand out compared to the normal call times that make up most of the graph. 
...
THe day with the highest z-score is the day with the most amount of calls which was 23 calls. 
...
Some angles for reporting are why some months have more calls than others. Another angle I would look at is why some days of the week have more average calls than othewrs. My next steps would be to reach out to people to obtain information about why some months have way more average calls than others and what is the reasoning for that. 
